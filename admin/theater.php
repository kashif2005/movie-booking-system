				...
				<div class="main__table-wrap">
					<table class="main__table">
						...
						<tbody id="tableLoad">
							...
							<tr>
								<td>
									<div class="main__table-text"><?php echo $roww['theater_id'] ?></div>
								</td>
								<td>
									<div class="main__table-text"><?php echo $roww['theater_name'] ?></div>
								</td>
								<td>
									<div class="main__table-text"><?php echo $roww['theater_address'] ?></div>
								</td>
								<td>
									<div class="main__table-text"><?php echo $roww['theater_seat'] ?></div>
								</td>
								<td>
									<div class="main__table-btns">
										<a href="edit-theater.php?id=<?= $roww['theater_id'] ?>" class="main__table-btn main__table-btn--view ">
											<i class="icon ion-ios-create"></i>
										</a>

										<a href="delete-theater.php?id=<?= $roww['theater_id'] ?>" class="main__table-btn main__table-btn--delete">
