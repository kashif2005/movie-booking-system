				...
				<form method="POST" enctype="multipart/form-data" class="form">
					<div class="row row--form">
						...
						<div class="col-12 col-md-7 form__content">
							<div class="row row--form">
								<div class="col-12">
									<input type="text" name="category_name" class="form__input" placeholder="Title">
								</div>

								<div class="col-12">
									<textarea id="text" name="category_price" class="form__textarea" placeholder="price"></textarea>
								</div>
...
if (isset($_POST['btn'])) {
	...
	$q = "insert into category values(null,'$category_name','$category_price',0)";
