				...
				<div class="main__title">
					...
					<div class="main__title-wrap">
						...
						<div class="filter" id="filter__sort">
							<a href="add-category.php" class="main__title-link">Add Category</a>
						</div>
						<!-- end filter sort -->
				...
				<div class="main__table-wrap">
					<table class="main__table">
						...
						<tbody id="tableLoad">
							...
							<tr>
								<td>
									<div class="main__table-text"><?php echo $roww['category_id'] ?></div>
								</td>
								<td>
									<div class="main__table-text"><?php echo $roww['category_name'] ?></div>
								</td>
								<td>
									<div class="main__table-text"><?php echo $roww['category_price'] ?></div>
								</td>
								<td>
									<div class="main__table-btns">
										<a href="edit-category.php?id=<?= $roww['category_id'] ?>" class="main__table-btn main__table-btn--view ">
											<i class="icon ion-ios-create"></i>
										</a>

										<a href="delete-category.php?id=<?= $roww['category_id'] ?>" class="main__table-btn main__table-btn--delete">
